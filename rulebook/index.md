...
Below is a brief historical introduction to `The Toyota Wars`. For more in-depth historical details which are not indepseansble for understanding gameplay, visit our [history corner](/)!
...
There are multiple possible scenarios to chose from when playing `The Toyota Wars`, each of them covering a specific period in the Chadian civil war and the Chadian-Lybian conflict.
...
If you take a quick look at the combat unit game pieces, you will notice a few of the basic traits that characterize different armies and commanders involved. A few of these characteristics are listed here.
