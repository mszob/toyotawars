...
function myFunction() {
    ...
    var shiftDice = document.getElementById("dice");
    shiftDice.classList.toggle("shiftdice");
}
...
function myFunction2() {
    ...
    popup.classList.toggle("show2");
      var fade = document.getElementById("runnerbackground");
    fade.classList.toggle("show3");
}
...
(function() {
   ...
   */
  Runner.keycodes = {
    JUMP: { "87": 1 }, // W, Up, spacebar
    DUCK: { "83": 1 }, // S, Down
    RESTART: { "82": 1 } // W, Enter**/
  };
